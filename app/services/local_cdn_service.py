...
class LocalCDNService:
    ...
    def _is_cache_valid(self, file_path: str) -> bool:
        ...
        cached_at = datetime.fromisoformat(self.cache_metadata["files"][file_path]["cached_at"])
    ...
    def get_cache_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "hit_rate": round(
                ...
                max(1, self.cache_metadata["stats"]["hits"] + self.cache_metadata["stats"]["misses"]) * 100, 
                2
            )
        }
